...
""" This module contains example gTAs that were used to demonstrate the
    effectiveness of our MINREACH algorithm.

    Note that the same caveats to the input format apply as stated
    in `example_dtns.py`.
"""
...
star_4 = GTA(
    locations, init_states, to_gta_transitions(transitions), invariants, clocks=clocks
)
...
invariants = {
    ...
    "q4_pre": Constraint("x", "0", Bound.leq(1)),
...
invariants = {
    ...
    "q5_pre": Constraint("x", "0", Bound.leq(1)),
...
invariants = {
    ...
    "q6_pre": Constraint("x", "0", Bound.leq(1)),
...
invariants = {
    ...
    "q7_pre": Constraint("x", "0", Bound.leq(1)),
